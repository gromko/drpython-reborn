...
class drToolBarDialog(wx.Dialog):
    ...
    def __init__(self, parent):
        wx.Dialog.__init__(self, parent, -1, "Customize ToolBar", wx.DefaultPosition, (-1, -1), wx.DEFAULT_DIALOG_STYLE )
        wx.Yield()
        ...
        self.programmenu = wx.ListBox(self, self.ID_PROGRAM, wx.DefaultPosition, (250, 250), programmenulist)

        self.toolbaritems = wx.ListBox(self, self.ID_POPUP, wx.DefaultPosition, (250, 250), ToolBarList)
        ...
        self.txt16 = wx.TextCtrl(self, -1, "<Default>", wx.DefaultPosition, (200, -1), wx.TE_READONLY)
        self.btn16 = wx.Button(self, self.ID_16, "Change")

        self.txt24 = wx.TextCtrl(self, -1, "<Default>", wx.DefaultPosition, (200, -1), wx.TE_READONLY)
    ...
    def OnbtnSave(self, event):
        toolbarfile = os.path.join(self.parent.datdirectory, "toolbar.dat")

        msg = "Succesfully wrote to:\n"  + toolbarfile + "\nand updated the current instance of DrPython."

        #Custom Bitmaps.
        if self.customNames:
            toolbarcustomfile = os.path.join(self.parent.datdirectory, "toolbar.custom.icons.dat")
            f = open(toolbarcustomfile, 'w')
            x = 0
