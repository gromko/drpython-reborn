...
class drSashWindow(wx.adv.SashLayoutWindow):
    def __init__(self, parent, id, pos, size, style=0):
        wx.adv.SashWindow.__init__(self, parent, id, pos, size, style)
...
class drMainPanel(wx.Panel):
    def __init__(self, parent, id):
        ...
        self.prompt = drSashWindow(self, self.ID_PROMPT, wx.DefaultPosition, wx.DefaultSize, wx.adv.SW_3D)        
        
	
        self.document = drSashWindow(self, self.ID_DOCUMENT, wx.DefaultPosition, wx.DefaultSize, wx.adv.SW_3D)

        self.leftsize = self.parent.prefs.sidepanelleftsize
        self.left = drSashWindow(self, self.ID_LEFT, wx.DefaultPosition, wx.DefaultSize, wx.adv.SW_3D)

        self.rightsize = self.parent.prefs.sidepanelrightsize
        self.right = drSashWindow(self, self.ID_RIGHT, wx.DefaultPosition, wx.DefaultSize, wx.adv.SW_3D)

        self.topsize = self.parent.prefs.sidepaneltopsize
	
        self.top = drSashWindow(self, self.ID_TOP, wx.DefaultPosition, wx.DefaultSize, wx.adv.SW_3D)
        ...
        self.Bind(wx.adv.EVT_SASH_DRAGGED_RANGE, self.OnSashDrag, id=self.ID_DOCUMENT)
        self.Bind(wx.adv.EVT_SASH_DRAGGED_RANGE, self.OnSashDrag, id=self.ID_PROMPT)
  
        if True: #not parent.PLATFORM_IS_GTK:
	#if 0:
            self.document.SetSashVisible(wx.adv.SASH_BOTTOM, True)
            #self.document.SetSashBorder(wx.adv.SASH_BOTTOM, True)
            self.prompt.SetSashVisible(wx.adv.SASH_TOP, True)
            #self.prompt.SetSashBorder(wx.adv.SASH_TOP, True)
            self.document.SetSashVisible(wx.adv.SASH_LEFT, True)
            #self.document.SetSashBorder(wx.adv.SASH_LEFT, True)
            self.document.SetSashVisible(wx.adv.SASH_RIGHT, True)
            #self.document.SetSashBorder(wx.adv.SASH_RIGHT, True)
            self.document.SetSashVisible(wx.adv.SASH_TOP, True)
            #self.document.SetSashBorder(wx.adv.SASH_TOP, True)

            self.prompt.SetSashVisible(wx.adv.SASH_LEFT, True)
            #self.prompt.SetSashBorder(wx.adv.SASH_LEFT, True)
            self.prompt.SetSashVisible(wx.adv.SASH_RIGHT, True)
            #self.prompt.SetSashBorder(wx.adv.SASH_RIGHT, True)
...
class drDocNotebook(drNotebook):
    def __init__(self, parent, id):
        ...
        images = [wx.Bitmap(wx.Image(os.path.join(grandparent.bitmapdirectory, "16/unmodified.png"), wx.BITMAP_TYPE_PNG)),
        wx.Bitmap(wx.Image(os.path.join(grandparent.bitmapdirectory, "16/modified.png"), wx.BITMAP_TYPE_PNG)),
        wx.Bitmap(wx.Image(os.path.join(grandparent.bitmapdirectory, "16/active unmodified.png"), wx.BITMAP_TYPE_PNG)),
        wx.Bitmap(wx.Image(os.path.join(grandparent.bitmapdirectory, "16/active modified.png"), wx.BITMAP_TYPE_PNG))]
...
class drPromptNotebook(drNotebook):
    def __init__(self, parent, id):
        ...
        images = [wx.Bitmap(wx.Image(os.path.join(grandparent.bitmapdirectory, "16/not running.png"), wx.BITMAP_TYPE_PNG)),
        wx.Bitmap(wx.Image(os.path.join(grandparent.bitmapdirectory, "16/running.png"), wx.BITMAP_TYPE_PNG)),
        wx.Bitmap(wx.Image(os.path.join(grandparent.bitmapdirectory, "16/active not running.png"), wx.BITMAP_TYPE_PNG)),
        wx.Bitmap(wx.Image(os.path.join(grandparent.bitmapdirectory, "16/active running.png"), wx.BITMAP_TYPE_PNG))]        
...
class drSplitTextPanel(wx.Panel):
    def __init__(self, parent, grandparent, targetstc, position, index):
        ...
        self.topSizer.Add(self.btnClose, 0, wx.SHAPED)
