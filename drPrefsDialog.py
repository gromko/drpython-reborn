...
class DocumentPanel(PrefsPanel):
    ...
    def __init__(self, parent, id, name):
        ...
        self.Add(self.chkignoretextfunctionkeys, "Ignore Text Function Keys:")
...
class GeneralPanel(PrefsPanel):
    ...
    def __init__(self, parent, id, name):
        ...
        if defaultlocale is not None:
            self.encodings = [defaultlocale, "ascii", "utf-8", "latin-1", "cp1252", "utf-16"]
        else:
            self.encodings = ["ascii", "utf-8", "latin-1", "cp1252", "utf-16"]
