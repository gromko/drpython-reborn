...
class drScriptDialog(drTreeDialog):
    def __init__(self, parent):
        ...
        "drscriptdialog.sizeandposition.dat", os.path.join(parent.bitmapdirectory, "16/drscript.png"), BuildTreeFromString, self.WriteBranch)
    ...
    def OnbtnSave(self, event):
        ...
        shortcutsfile = os.path.join(self.parent.shortcutsdirectory, "drscript.shortcuts.dat")
        try:
